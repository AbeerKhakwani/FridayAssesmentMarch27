<?php
  ...
  Class StoreTest extends PHPUnit_Framework_TestCase
    ...
    //    CREATE - save method stores all object data in categories table.
        ...
        //Now we write a test for the getBrands method since we need it to be able to test the Add Brand method.
        function testGetStudents()
        {
            ...
            //Assert
            //we should get both of them back when we call getBrands on the test store.
